...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tomli-w-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14163&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tomli-w-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tomli-w` can be installed with:

```
conda install tomli-w
```

It is possible to list all of the versions of `tomli-w` available on your platform with:
